        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-6">
                    <a href="service-details.php" class="service-card-v2 tmponhover tmp-scroll-trigger tmp-fade-in animation-order-1">
                    ...
                    <a href="service-details.php" class="service-card-v2 tmponhover tmp-scroll-trigger tmp-fade-in animation-order-2">
                    ...
                    <a href="service-details.php" class="service-card-v2 tmponhover tmp-scroll-trigger tmp-fade-in animation-order-3">
                ...
                <div class="col-lg-6 col-sm-6">
                    <a href="service-details.php" class="service-card-v2 tmponhover tmp-scroll-trigger tmp-fade-in animation-order-4">
                    ...
                    <a href="service-details.php" class="service-card-v2 tmponhover tmp-scroll-trigger tmp-fade-in animation-order-5">
                    ...
                    <a href="service-details.php" class="service-card-v2 tmponhover tmp-scroll-trigger tmp-fade-in animation-order-6">
            ...
            <div class="row align-items-center">
                <div class="col-lg-4 col-md-6">
                    <div class="price-plan-card tmponhover blur-style-two tmp-scroll-trigger tmp-fade-in animation-order-1">
                        ...
                        <div class="tmp-button-here">
                            <a class="tmp-btn hover-icon-reverse btn-border btn-md radius-round" href="contact.php">
                ...
                <div class="col-lg-4 col-md-6 tmp-scroll-trigger tmp-fade-in animation-order-2">
                    <div class="price-plan-card tmponhover blur-style-two active">
                        ...
                        <div class="tmp-button-here">
                            <a class="tmp-btn hover-icon-reverse btn-md radius-round" href="contact.php">
                                <span class="icon-reverse-wrapper">
                    <span class="btn-text">Get Started</span>
                                <span class="btn-icon"><i class=" fa-solid fa-arrow-right"></i></span>
                                <span class="btn-icon"><i class=" fa-solid fa-arrow-right"></i></span>
